    ...
    contentItem: ColumnLayout {
        ...
        StackLayout {
            ...
            Kirigami.FormLayout {
                ...
                Kirigami.Heading { level: 4; text: qsTr("ListenBrainz Settings") }
                TextField {
                ...
                Kirigami.Heading { level: 4; text: qsTr("Last.fm Authentication") }
                Button {
            ...
            // Visualizer Tab
            Kirigami.FormLayout {
                Kirigami.Heading { level: 4; text: qsTr("Visualizer Settings") }
            ...
            // ProjectM Tab
            Kirigami.FormLayout {
                Kirigami.Heading { level: 4; text: qsTr("ProjectM Preset Path") }
                RowLayout {
                    Layout.fillWidth: true
                    TextField {
                        id: presetPathField
