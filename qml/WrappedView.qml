...
Kirigami.ScrollablePage {
    ...
    ColumnLayout {
        ...
        spacing: Kirigami.Theme.largeSpacing
        ...
        Repeater {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    spacing: Kirigami.Theme.mediumSpacing
                    Kirigami.Heading { level: 4; text: (index + 1) + "."; Layout.alignment: Qt.AlignTop }
                    ColumnLayout {
                        Text { text: modelData.name || ""; font.bold: true }
                        Text { text: (modelData.listen_count || 0) + " listens"; font.pixelSize: 12; color: Kirigami.Theme.passiveTextColor }
                    }
                }
            }
        }
        ...
        Kirigami.Heading {
            ...
            Layout.topMargin: Kirigami.Theme.mediumSpacing
            visible: !!(statistics.externalActivityData && 
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text { text: modelData.artist || ""; font.pixelSize: 12; color: Kirigami.Theme.passiveTextColor }
                    }
                    Text { text: (modelData.play_count || 0) + " plays" }
                }
            }
        }
        ...
        Repeater {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    spacing: Kirigami.Theme.mediumSpacing
                    Kirigami.Heading { level: 4; text: (index + 1) + "."; }
                    Text { text: modelData.name; Layout.fillWidth: true; font.bold: true }
                    Text { text: Math.floor(modelData.ms / 60000) + "m" }
                }
            }
        }
